...
class LoginregisterViewModel extends AppBaseViewModel {
  ...
  void navigateToLogin() {
    _navigationService.navigateTo(Routes.loginView); // Replace with your actual login route
  }

  void navigateToRegister() {
    _navigationService.navigateTo(Routes.registerView); // Replace with your actual register route
  }
}
